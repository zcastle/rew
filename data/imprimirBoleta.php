...
class MYPDF extends TCPDF {
    ...
    public function Footer() {
        ...
        $this->Cell(80, 0, 'GRACIAS POR SU VISITA', 0, true, 'C');
...
$pdf->setNumeroTicket("001-0000123");
...
$resolution = array(80, 112 + (10 * count($detalle)));
